...
class PaginaMenuAnon extends StatefulWidget {
  get fade => null;

  _PaginaMenuAnon createState() => new _PaginaMenuAnon();
}

bool isLoggedIn = false;
bool isLogged = false;

class _PaginaMenuAnon extends State<PaginaMenuAnon> {
  bool isLogged = false;
  ...
  Future<FirebaseUser> _loginAsFacebook() async {
    ...
    if (result.status == FacebookLoginStatus.loggedIn) {
      ...
      Navigator.push(
        ...
        MaterialPageRoute(
            builder: (context) =>
                PaginaMenuAnon()), //envía a la siguenta pantalla en caso de ser logueado
      );
      return _user;
    }
    return null;
                  ...
                  decoration: BoxDecoration(
                    ...
                    children: <Widget>[
                      FadeAnimation(//sector donde se efectua la transición
                          ...
                          Text(
                            "Presione el boton verde para realizar búsqueda y el celeste para cambiar de usuario.",
                            style: TextStyle(
